...
# Message: The residual stream encodes the WHOLE latent hierarchy, and deeper /
#   more local latents are MORE linearly decodable than the global root. R^2
#   climbs monotonically from the root (L0) down to the deepest level-2 latents.
...
order = ["root_L0", "mid_L1a", "mid_L1b", "low_L2a", "low_L2d"]
labels = ["Root\n(L0)", "Mid\n(L1a)", "Mid\n(L1b)", "Low\n(L2a)", "Low\n(L2d)"]
...
ax.set_title("Deeper, more local latents are more strongly encoded")
